...
- Added FapNation catalogs, search, pagination, tag browsing, details and galleries.
...
- Improved H-Game18 Cloudflare recovery, F95Zone/LewdZone developer metadata, developer social actions and automatic game-version extraction from downloads.
